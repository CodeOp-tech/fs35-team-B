...
('', 'https://youtu.be/Sh6lK57Cuk4?si=xgssyNkDTlQuSF1D', '', '', 'JavaScript Tutorial for Beginners - FreeCodeCamp', 1, 0),
('', 'https://youtu.be/lkIFF4maKMU?si=8PGcHcI5Wngxd-C9', '', '', 'JavaScript Crash Course For Beginners - Traversy Media', 1, 0),
('', 'https://youtu.be/Tn6-PIqc4UM?si=RC8-aY47-T5RqDFT', '', '', 'JavaScript Tutorial for Beginners: Learn JavaScript in 1 Hour', 1, 0),
('', 'https://youtu.be/-qfEOE4vtxE?si=3f8J0VxWugvt0LTX', '', '', 'JavaScript ES6 Tutorial', 1, 0),
('', 'https://youtu.be/Cz3WcZLRaWc?si=QF9nlRKskgx2WR15', '', '', 'JavaScript Full Course', 1, 0),
('', 'https://youtu.be/ENrzD9HAZK4?si=ZyNNwdqz8HevAR46', '', '', 'Modern JavaScript Tutorial', 1, 0);    
